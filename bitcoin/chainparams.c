...
const struct chainparams networks[] = {
    ...
    {.network_name = "liquid",
     ...
     .cli_args = NULL,
     .dust_limit = { 100000 },
     .max_funding = AMOUNT_SAT_INIT(128 * ((1 << 24) - 1)),
     .max_payment = AMOUNT_MSAT_INIT(128 * 0xFFFFFFFFULL),
     .when_lightning_became_cool = 79250,
     .p2pkh_version = 53,
     .p2sh_version = 55,
     .testnet = false,
    ...
    {.network_name = "actinium-testnet",
     .bip173_name = "tacm",
     .bip70_name = "test",
     .genesis_blockhash = {{{.u.u8 = { 0x1b, 0x1f, 0xf8, 0xf9, 0x99, 0xf0, 0x9e, 0xd1, 0xc2, 0xaf, 0xb1, 0x9a, 0x35, 0x71, 0xe8, 0xc4, 0x0c, 0x85, 0x6b, 0x6d, 0x21, 0x36, 0x78, 0x49, 0xf1, 0xbf, 0xc2, 0x4d, 0xc8, 0x7c, 0x61, 0x7c }}}},
     .rpc_port = 2301,
     .cli = "Actinium-cli",
     .cli_args = "-testnet",
     .dust_limit = { 100000 },
